...
/**
 * This is the item provider adapter for a {@link courceList.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_nr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_nr_feature", "_UI_Student_type"),
				 CourceListPackage.Literals.STUDENT__NR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Student_type") + " " + student.getNr();
	}
