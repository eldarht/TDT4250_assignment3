...
/**
 * This is the item provider adapter for a {@link courceList.Work} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Work_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Work_weight_feature", "_UI_Work_type"),
				 CourceListPackage.Literals.WORK__WEIGHT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Work_type") + " " + work.getWeight();
	}
