...
/**
 * This is the item provider adapter for a {@link courceList.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CourceListPackage.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAbbreviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Department_abbreviation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Department_abbreviation_feature", "_UI_Department_type"),
				 CourceListPackage.Literals.DEPARTMENT__ABBREVIATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CourceListPackage.Literals.DEPARTMENT__STUDY_PROGRAM);
			childrenFeatures.add(CourceListPackage.Literals.DEPARTMENT__COURSE);
			childrenFeatures.add(CourceListPackage.Literals.DEPARTMENT__PROFESSOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CourceListPackage.Literals.DEPARTMENT__STUDY_PROGRAM,
				 CourceListFactory.eINSTANCE.createStudyGeneralization()));

		newChildDescriptors.add
			(createChildParameter
				(CourceListPackage.Literals.DEPARTMENT__COURSE,
				 CourceListFactory.eINSTANCE.createCource()));

		newChildDescriptors.add
			(createChildParameter
				(CourceListPackage.Literals.DEPARTMENT__PROFESSOR,
				 CourceListFactory.eINSTANCE.createProfessor()));
	}
