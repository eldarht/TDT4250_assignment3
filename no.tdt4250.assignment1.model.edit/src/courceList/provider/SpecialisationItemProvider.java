...
/**
 * This is the item provider adapter for a {@link courceList.Specialisation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecialisationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CourceListPackage.Literals.SPECIALISATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CourceListPackage.Literals.SPECIALISATION__START_SEMESTER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CourceListPackage.Literals.SPECIALISATION__COURCE);
			childrenFeatures.add(CourceListPackage.Literals.SPECIALISATION__FURTHER_SPECIALISATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CourceListPackage.Literals.SPECIALISATION__COURCE,
				 CourceListFactory.eINSTANCE.createStudyCourceRelation()));

		newChildDescriptors.add
			(createChildParameter
				(CourceListPackage.Literals.SPECIALISATION__FURTHER_SPECIALISATION,
